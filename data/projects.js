export const projects = [
    ...
    },
    {
      ...
      title: '<Studio 131>',
      date: '2021',
      shortDescription: 'Maquettage du site de présentation et réervation du studio',
      fullDescription: "Ce projet nous a été proposé en workshop d’ux/ui design au début de mon année de licence pro Webdesign. Nous devions maquetter le site du studio 131 de Chanel afin qu’il permette aux professionnels de l’audiovisuel de le découvrir mais également de le réserver avec ou non des services annexes. Pour ce projet de 3 jours, nous devions seulement penser au coté ux/ui du site, l'identité visuelle nous étant fournie. Nous avons exclusivement utilisé Figma pour mener à bien le projet, ce qui m’a permis d’expérimenter les animations en phase de prototypage.",
      technologies: ['Figma'],
      fond: '/img/mockups/chanel.jpg',
      images: [
        '/img/galeriesprojets/chanel1.jpg',
        '/img/galeriesprojets/chanel2.jpg',
        '/img/galeriesprojets/chanel3.png',
        '/img/galeriesprojets/chanel4.jpg',
        '/img/galeriesprojets/chanel5.jpg',
      ],
    ...
    {
      id: 'paroledecrabe',
      title: '<Parole de crabe>',
      date: 'Janvier 2022',
      shortDescription: "Site dédié aux personnes atteintes d'un cancer' ( doc, forum, matériel ... )",
      fullDescription: "Parole de crabe constitue le site que j’ai du réaliser dans le cadre de la mise en situation professionnelle lors de mon année de Licence pro Webdesign. Le principe est très simple, nous avons une semaine pour répondre à un appel d’offre d’un client fictif. Notre sujet était de créer un site à propos du cancer, dans lequel les utilisateurs ( visiteurs, malades ou proches de malades ) pourraient avoir accès à un forum, des annonces de matériel, de la documentation sur le cancer etc… Je suis donc parti sur une harmonie colorée dans les tons pastel, un style global plutôt sobre et épuré pour ne laisser que le nécessaire. Afin d’ajouter une dimension humaine, j’ai décidé d’incorporer des illustrations en flat design un peu partout dans le site. Une fois les maquettes finies, je suis passé au développement. J’ai utilisé Wordpress comme base et ai développé un thème spécifique au site avec GulpJS afin de pouvoir utiliser des SCSS. Finalement, le site a été terminé dans les temps , il comporte toutes les fonctionnalités énoncées dans le cahier des charges, avec un espace utilisateur et un forum fonctionnel.",
      technologies: ['WordPress', 'Figma', 'Illustrator', 'Gulp.js', 'HTML/CSS'],
      fond: '/img/mockups/pdc.jpg',
      images: [
        '/img/galeriesprojets/pdc1.png',
        '/img/galeriesprojets/pdc2.png',
        '/img/galeriesprojets/pdc3.png',
        '/img/galeriesprojets/pdc4.png',
        '/img/galeriesprojets/pdc5.png',
      ],
    ...
    },
    {
      ...
      title: '<O80>',
      date: '2021 / 2022',
      shortDescription: "Marque d'eau de mer dessalée",
      fullDescription: "O80 est un projet de groupe sur lequel j’ai travaillé lors de mon année de Licence pro Webdesign. Le but était de créer de A à Z une marque d’eau, de penser toute l’identité de marque, et de “teaser” sa sortie sur 5 semaines pour officiellement la présenter au public au salon Vinovision de 2022. Afin de nous démarquer des autres groupes, nous avons choisi de partir sur une marque d’eau de mer dessalée, à l’image de Odeep. Notre nom de marque fait donc référence aux 79 minéraux qui se trouvent dans notre eau mais aussi au fait que la terre est constituée à 80% d’eau. Tout notre concept tourne autour de l’eau de mer et de ses bienfaits quand elle est dessalée. Nous avons choisi de communiquer le teasing de notre marque sur instagram dans un premier temps, et avec trois encarts publicitaires étalés sur 4 semaines, qui permettent de dévoiler un peu plus chaque semaine notre marque avant sa sortie. Pour finir, nous avons aussi désigné l'esthétique de notre stand au salon.",
      technologies: ['Photoshop', 'Illustrator'],
      fond: '/img/mockups/o80.png',
      images: [
        '/img/galeriesprojets/o801.png',
        '/img/galeriesprojets/o802.jpg',
        '/img/galeriesprojets/o803.jpg',
        '/img/galeriesprojets/o804.jpg',
        '/img/galeriesprojets/o805.jpg',
        '/img/galeriesprojets/o806.jpg',
        '/img/galeriesprojets/o807.png',
        '/img/galeriesprojets/o808.png',
      ],
    },
  ]
